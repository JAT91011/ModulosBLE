...
//Cada cliente conectado tiene su propia configuracion
  ...
  switch ( param )
  {
    ...
    case SIMPLEPROFILE_CHAR2:
      if ( len == SIMPLEPROFILE_CHAR2_LEN ) 
      {
        ...
        //Comprueba que la notificacion ha sido activada
        GATTServApp_ProcessCharCfg( simpleProfileChar2Config, simpleProfileChar2, FALSE, simpleProfileAttrTbl, GATT_NUM_ATTRS( simpleProfileAttrTbl ), INVALID_TASK_ID );
      }
      else
      {
        ret = bleInvalidRange;
